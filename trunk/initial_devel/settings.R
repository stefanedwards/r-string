...
organisms <- list()
organisms$'9913' <- list(short='Bt', long='Bos taurus', primary='ensembl', db='org.Bt.eg.db', db_conn='org.Bt.eg_dbconn', ens2eg='org.Bt.egENSEMBLPROT2EG', has.entrez=TRUE)
organisms$'9606' <- list(short='Hs', long='Homo sapiens', primary='ensembl', db='org.Hs.eg.db', db_conn='org.Hs.eg_dbconn', ens2eg='org.Hs.egENSEMBLPROT2EG', has.entrez=TRUE)
